...
#define MAKE_SET_ACTION(id, kind, setting_, handler)                                                  \
	...
	MAKE_ACTION(OPEN_FORCED, wxITEM_NORMAL, OnOpenForced);
	...
	MAKE_ACTION_ICON(GHOST_GROUNDS, wxITEM_CHECK, ICON_GHOST, OnChangeViewSettings);
	...
	MAKE_ACTION_ICON(SHOW_LIGHTS, wxITEM_CHECK, ICON_LIGHTBULB, OnToggleShowLights);
	...
	MAKE_ACTION_ICON(SHOW_PICKUPABLES, wxITEM_CHECK, ICON_HAND_POINTER_SOLID, OnChangeViewSettings);
	MAKE_ACTION_ICON(SHOW_MOVEABLES, wxITEM_CHECK, ICON_ARROWS_UP_DOWN_LEFT_RIGHT, OnChangeViewSettings);
	...
	MAKE_ACTION(SHOW_SHADOW_OCCLUSION, wxITEM_CHECK, OnChangeViewSettings);
	MAKE_ACTION(SHOW_CUSTOM_ITEM_LIGHTS, wxITEM_CHECK, OnChangeViewSettings);
	MAKE_ACTION(SHOW_FORCED_LIGHT_ZONES, wxITEM_CHECK, OnChangeViewSettings);
	MAKE_ACTION(SHOW_ZONE_BOUNDARIES, wxITEM_CHECK, OnChangeViewSettings);
	MAKE_ACTION(RELOAD_FORCED_LIGHT_DATA, wxITEM_NORMAL, OnReloadForcedLightData);
	...
	MAKE_ACTION(WIN_CLAUDE_ASSISTANT, wxITEM_NORMAL, OnClaudeAssistantWindow);
