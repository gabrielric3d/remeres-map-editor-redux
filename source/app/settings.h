...
namespace Config {
	enum Key {
		...
		REPLACE_TOOL_AUTO_ADD_RULE,
		REPLACE_TOOL_AUTO_ASSIGN_PALETTE,
		WELCOME_DIALOG,
		...
		CREATURE_FAVORITES,
		CREATURES_JSON_PATH,
		CREATURES_AUTO_LOAD_ENABLED,
		CREATURES_AUTO_LOAD_DIR,
		GROUND_REPLACE_MODIFIER,
		SMART_BRUSH_MODIFIER,
		SMART_BRUSH_MOUSE_BUTTON,
		FAVORITE_FILES,
		SHOW_TOAST_NOTIFICATIONS,
		SHOW_WALL_BORDERS,
		SHOW_MOUNTAIN_OVERLAY,
		SHOW_STAIR_DIRECTION,
		PALETTE_GRID_ICON_SIZE,
		PALETTE_TILESET_SORT_MODE,
		PALETTE_TILESET_SHOW_LABELS,
