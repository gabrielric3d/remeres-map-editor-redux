...
#define String(key, dflt)                                              \
	...
	Float(PALETTE_SCROLL_SPEED, 1.0f);
	...
	Bool(ERASE_FLOORS_BRUSH_ONLY, true);
	Bool(PUNCH_GROUND_BELOW_ENABLED, false);
	...
	String(CLAUDE_MODEL, "claude-opus-5");
	String(CLAUDE_EFFORT, "high");
	Bool(CLAUDE_SHOW_THINKING, true);
	String(CLAUDE_PANEL_LAYOUT, "");
	String(CLAUDE_BACKEND, "claude_code");
