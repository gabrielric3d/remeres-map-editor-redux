...
GeneralPage::GeneralPage(wxWindow* parent) : ScrollablePreferencesPage(parent) {
	...
	auto* creature_section = new PreferencesSectionPanel(
		GetScrollWindow(),
		"Creature Data",
		"Configure external creature data sources."
	);
	creatures_json_picker = new wxFilePickerCtrl(creature_section, wxID_ANY, wxstr(g_settings.getString(Config::CREATURES_JSON_PATH)),
