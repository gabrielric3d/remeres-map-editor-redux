...
namespace Config {
	enum Key {
		...
		USE_LAZY_LOADING_SPRITES,
		USE_SPRITE_CACHE,
		SPRITE_CACHE_SIZE,
		USE_DISK_SPRITE_CACHE,
		USE_OPTIMIZED_MAP_LOADING,
		USE_ANTIALIASING,
		SOFTWARE_CLEAN_SIZE,
		TRANSPARENT_FLOORS,
		TRANSPARENT_ITEMS,
		TRANSPARENT_GROUND_ITEMS,
		SHOW_INGAME_BOX,
		CUSTOM_CLIENT_BOX,
		CLIENT_BOX_WIDTH,
		CLIENT_BOX_HEIGHT,
		...
		FULL_DETAIL_ZOOM_OUT,
		SELECTED_TILE_INDICATOR,
		GROUP_ACTIONS,
		SCROLL_SPEED,
		ZOOM_SPEED,
		UNDO_SIZE,
		...
		DEFAULT_SPAWNTIME,
		SWITCH_MOUSEBUTTONS,
		MOUSE_ACTION_PRIMARY_BUTTON,
		MOUSE_ACTION_CAMERA_BUTTON,
		MOUSE_ACTION_PROPERTIES_BUTTON,
		MOUSE_BINDINGS_VERSION,
		DOUBLECLICK_PROPERTIES,
		RAW_PALETTE_SELECT_MODIFIER,
		...
		WINDOW_MAXIMIZED,
		WELCOME_DIALOG,
		IGNORE_WARNINGS_ON_OPEN,
		CONFIRM_RECENT_OPEN,

		NUMERICAL_HOTKEYS,
		MENU_ACTION_HOTKEYS,
		MOUSE_ACTION_KEYBOARD_HOTKEYS,
		RECENT_FILES,
		FAVORITE_FILES,
		...
		RECENT_BRUSHES_VISIBLE,
		RECENT_BRUSHES_LAYOUT,
		...
		FLOOR_FADING,
		FLOOR_FADING_MODE,
		FLOOR_FADING_DURATION,
		FLOOR_FADING_EASING,
		FLOOR_FADING_OPACITY,
