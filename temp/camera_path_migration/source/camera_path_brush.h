...
#ifndef RME_CAMERA_PATH_BRUSH_H_
#define RME_CAMERA_PATH_BRUSH_H_

#include "brush.h"

class CameraPathBrush : public Brush
{
public:
	CameraPathBrush();
	virtual ~CameraPathBrush();

	bool isCameraPath() const { return true; }
	CameraPathBrush* asCameraPath() { return static_cast<CameraPathBrush*>(this); }
	...
	virtual std::string getName() const { return "Camera Path Brush"; }
};
